...
- In multi-pane mode, tapping or scrolling content hides the workspace and pane title bars. Tap a centered top-edge handle to reveal them again. The Add pane menu offers **Keep title bars visible**; VoiceOver also keeps them visible. Header controls and dragging do not hide the bars, and Reduce Motion disables the transition.
